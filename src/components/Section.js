...
<div className="mt-5 text-t-40" >
  <div className="mx-auto w-11/12 bg-gray-900 mt-5 p-5  grid lg:grid-cols-2 gap-5">
    <div>
    <h1 className="text-3xl text-white font-semibold font-signature contrast-200">Top Creators</h1>
...

    {
      Creators.map((c) =>{
        ...
        return (
          <div className='flex border-b-2 border-t-50 rounded-lg items-center gap-2  justify-between' key={id}>
...
<div>
<h1 className="text-3xl text-white font-semibold font-signature contrast-200">Categories</h1>
...

    {
       Categories.map((j)=>{
        ...
        return (
          ...
          <div className=' bg-org flex flex-col lg:w-64 lg:h-46 rounded-lg contrast-200 border-2 border-t-10 items-center pb-2 '
          key={id} >
          ...
          <div className='flex text-black items-center justify-between px-3 lg:w-56 w-32  md:w-52'>
            <p className= ' lg:text-xl font-semibold text-xs sm:text-2xl first-letter:font-signature first-letter:text-red'>{Name}</p>
            <p className='lg:text-lg text-xs'>{items}</p>
          </div>
